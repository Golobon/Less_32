...
public class DB {
    ...
    public Cursor getCompanyData() {
        return mDB.query(COMPANY_TABLE, null, null,
                null, null,
                null, null);
    }

    public Cursor getPhoneData(long companyTd) {
        return mDB.query(PHONE_TABLE, null,
                PHONE_COLUMN_COMPANY + " = " + companyTd,
                null, null,
                null, null);
    }
    class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String[] phonesHTC = new String[] {"Sansation", "Desire",
                    "Wildfire", "Hero" };
