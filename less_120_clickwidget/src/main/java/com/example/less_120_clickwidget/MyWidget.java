...
public class MyWidget extends AppWidgetProvider {
    final static String ACTION_CHANGE = "com.example.less_120_clickwidget.change_count";
    @Override
    ...
    static void updateWidget (Context ctx, AppWidgetManager appWidgetManager,
        ...
        updateIntent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_IDS,
                new int[] { widgetID });
        pIntent = PendingIntent.getBroadcast(ctx, widgetID,
                updateIntent, 0);
        ...
        countIntent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID,
                widgetID);
        pIntent = PendingIntent.getBroadcast(ctx, widgetID,
                countIntent, 0);
